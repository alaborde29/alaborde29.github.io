(window.webpackJsonp=window.webpackJsonp||[]).push([[9],{438:function(E,x,s){"use strict";s.r(x);var f=function(){var v=this,o=v.$createElement,i=v._self._c||o;return i("canvas",{ref:"canvas",staticClass:"canvas",attrs:{"aria-label":"landing background"}})},p=[],n=s(435),h=`#define GLSLIFY 1
